        ...
        <div class="row w-100">
            <div class="col-12 col-sm-10 col-md-8 col-lg-5 mx-auto">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-3 p-md-4" x-data="authController()">
                        ...
                        <form method="POST" action="<?php printf("%s%s", $GLOBALS["home_url"], "login"); ?>" @submit.prevent="handleSubmit($event)">
                            <div class="mb-3">
                                <label for="login" class="form-label">Login / E-mail / CPF</label>
                                <input x-model="form.login" type="text" class="form-control form-control-lg" id="login" name="login" required autofocus>
                            </div>

                            <div class="mb-4">
                                <label for="password" class="form-label">Senha</label>
                                <input x-model="form.password" type="password" class="form-control form-control-lg" id="password" name="password" required>
                            </div>
